...
console.log(cap("Jeg liker Javascript"));
...
console.log(greeting("Johannes", 12));
/******************************************************************************
4.
...
const arrayManipulator2000 = (array) => {
  array.pop();
  array.shift();
  return array;
};
...
console.log("Before Fred the fisherman fished:");
console.log(fishes);

console.log("After Fred the fisherman fished:");
console.log(arrayManipulator2000(fishes));
/******************************************************************************
5.
...
const therapist = (text) => {
  const oldText = text;
  if (oldText.includes("vanskelig")) {
    let newText = oldText.replace("vanskelig", "gøy");
    return newText;
  }
};

console.log(therapist("Javascript er vanskelig"));
...
console.log(arrayManipulator3000(items));
...
const farmAnimals = ["Cow", "Dog", "Pig", "Horse", "Cat"];
const badAnimal = "Pig";

const butcher = (array, string) => {
...
console.log(butcher(farmAnimals, badAnimal));
...
const textManipulator2000 = (input) => {
  if (typeof input === "string") {
    ...
    return input ? "😎Ja😎" : "😎Slapp av😎";
  } else {
    return "Kun primitive verdier";
  }
};

console.log(textManipulator2000(num));
